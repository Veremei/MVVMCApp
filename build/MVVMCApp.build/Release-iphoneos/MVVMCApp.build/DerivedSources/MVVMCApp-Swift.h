...
#ifndef MVVMCAPP_SWIFT_H
#define MVVMCAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MVVMCApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8MVVMCApp11AppDelegate")
...
SWIFT_CLASS("_TtC8MVVMCApp19LoginViewController")
...
SWIFT_CLASS("_TtC8MVVMCApp16RandomStringCell")
@interface RandomStringCell : UITableViewCell
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8MVVMCApp13SceneDelegate")
...
SWIFT_CLASS("_TtC8MVVMCApp25StringsListViewController")
@interface StringsListViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
@interface StringsListViewController (SWIFT_EXTENSION(MVVMCApp)) <UITableViewDataSource>
